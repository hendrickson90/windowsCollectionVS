...
namespace InputTrackingExample
{
    public partial class MainWindow : Window
    {
        ...
        void mouse_MouseMoved(object sender, EventArgs e)
        {
            ...
            IsOnText.Content = mouse.OnOff();
            //keyboard.GetKey();
            //mouse.OnOff();

            //Console.WriteLine("has mouse");
            if (mouse.stateChangeFlag)
            {
                savedKey = mouse.GetKey();
                keyboard.savedKey = savedKey;

                mouse.stateChangeFlag = false;
            }
        }
