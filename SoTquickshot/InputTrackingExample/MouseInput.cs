...
namespace InputTrackingExample
{
    ...
    public class MouseInput : IDisposable
    {
        ...
        public bool stateChangeFlag = false;
        ...
        private void oneTwo() {
            ...
            if (savedKey == 49) {
                Win32.keybd_event(50, 0, Win32.KEYEVENTF_EXTENDEDKEY, 0);
                Thread.Sleep(5);
                Win32.keybd_event(50, 0, Win32.KEYEVENTF_KEYUP , 0);
                savedKey = 50;
            } else if (savedKey == 50) {
                Win32.keybd_event(49, 0, Win32.KEYEVENTF_EXTENDEDKEY, 0);
                Thread.Sleep(5);
                Win32.keybd_event(49, 0, Win32.KEYEVENTF_KEYUP, 0);
                savedKey = 49;
            }
